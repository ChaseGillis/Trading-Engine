...
def main():
    ...
    ratio = TSLA / MSFT
    '''plt.figure(figsize=(10, 6))
    plt.plot(ratio, label = 'Price Ratio (TSLA / MSFT))')
    plt.axhline(ratio.mean(), color='red')
    plt.legend()
    plt.title("Price Ratio between TSLA and MSFT")'''
    ...
    plt.legend(loc = 'best')
    plt.title('Z score of Ratio of TSLA to MSFT')
    plt.show()'''
    ...
    plt.xlabel('Date')
    plt.ylabel('Ratio')
    plt.title('Ratio between TSLA and MSFT with 5 day and 20 day Moving Averages')
    plt.show()'''
    ...
    plt.title('Relationship TSLA to MSFT')
    plt.show()
